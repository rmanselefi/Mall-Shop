              ...
              children:<Widget>[
                Form(
                    ...
                    child: Column(
                      children: <Widget>[
                        TextFormField(
                          decoration: InputDecoration(labelText: 'Enter your old password',fillColor: Colors.white,labelStyle: TextStyle(
                              color:Colors.white
                          )),
                          style: TextStyle(
                            color: Colors.white,
                        ...
                        TextFormField(
                          decoration: InputDecoration(labelText: 'Enter your new password',fillColor: Colors.white,labelStyle: TextStyle(
                              color:Colors.white
                          )),
                          style: TextStyle(
                            color: Colors.white,
                        ...
                        TextFormField(
                          decoration: InputDecoration(labelText: 'Confirm password',fillColor: Colors.white,labelStyle: TextStyle(
                              color:Colors.white
                          )),
                          style: TextStyle(
                            color: Colors.white,
